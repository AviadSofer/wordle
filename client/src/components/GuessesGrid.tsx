            ...
            element={guesses.map((guess, guessKey) => (
              <Guess
                ...
                description={`משחק מילים עם ${
                  i + 4
                } אותיות ו6 ניחושים בעברית חינם, משחק מילים בעברית עם ${
                  i + 4
                } אותיות, משחק מילים יומי עם ${i + 4} אותיות, משחק מילים באורך ${
                  i + 4
                } אותיות בסגנון וורדל אונליין ללא הגבלה, משחק מילים עם ${
                  i + 4
                } אותיות אינסופי, כנסו לנחש מה המילה.`}
                guess={guess}
                letters={i + 4}
              />
            ))}
