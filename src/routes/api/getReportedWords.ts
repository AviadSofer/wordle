...
router.get('/', async (req: Request, res: Response, next: NextFunction) => {
  dbConnect().query('SELECT * from reportedWords', (err, results) => {
    if (err) {
...
router.post('/', async (req: Request, res: Response, next: NextFunction) => {
  ...
  dbConnect().query(`INSERT INTO reportedWords VALUE ('${word}');`, (err) => {
    if (err) {
...
router.delete('/', async (req: Request, res: Response, next: NextFunction) => {
  ...
  dbConnect().query(`DELETE FROM reportedWords WHERE word = '${word}';`, (err) => {
    if (err) {
